const en = {
  translation: {
    ...
    "login.errorCredentials": "Incorrect email or password. Please try again.",
    "login.errorServer": "Could not connect to the server. Check your connection or try again later.",
    "login.errorUnknown": "An unexpected error occurred. Please try again.",
