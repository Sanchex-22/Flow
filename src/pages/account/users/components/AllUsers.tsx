    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="text-3xl font-bold mb-1">{data?.filter((u: UsuarioFull) => u.isActive).length || 0}</div>
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700">
        <div className="p-6 border-b border-gray-700">
          ...
          <p className="text-gray-400 text-sm mb-6">{data?.length || 0} usuarios encontrados</p>
            ...
            <tbody>
              {data.map((usuario: UsuarioFull) => (
                <tr key={usuario.id} className="border-b border-gray-700 hover:bg-gray-750">
                  ...
                  <td className="p-4">
                    <div>
                      <div className="font-medium text-sm">{usuario.person.department?.name}</div>
          ...
          <div className="bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 border border-gray-700">
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-700 rounded-lg p-3 border border-gray-600">
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-medium text-sm ${getAvatarColor(deleteConfirmation.user?.person.fullName || "")}`}
                  >
