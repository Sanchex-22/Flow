...
import { FrontendNetworkConnection } from "./AllNetwork"
...
interface DeleteConfirmationModalProps {
  ...
  onClose: () => void
  onConfirm: () => void
  connection: FrontendNetworkConnection | null
  isDeleting: boolean
}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 max-w-md w-full mx-4">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">Eliminar Conexión</h3>
        ...
        <div className="mb-6">
          <p className="text-gray-300 mb-2">
            ...
            <span className="font-semibold text-white">"{connection?.nombre}"</span>?
          </p>
